...
<label>Member Name: </label><br> <input type="text" name="membernametextbox" size="30"/>
<br>
<label>Phone: </label><br> <input type="text" name="phonetextbox" size="30"/>
<br>
<label>Email: </label><br> <input type="text" name="emailtextbox" size="30"/>
<br>
<label>Date: </label><br> <input type="text" name="datetextbox" size="30"/>
<br>
<label>Payment Type: </label><br> <input type="text" name="paymenttypetextbox" size="30"/>
<br>
